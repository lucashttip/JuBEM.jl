...
function calc_GH_static_cubature!(mesh::mesh_type, material::Vector{material_table_type}, solver_var::solver_var_type)
        ...
        for se in 1:nelem
            ...
            for n = 1:nnel
                ...
                if fe != se
                        ...
                        HELEM, GELEM = integrate_static_cubature(source_node, field_points, csis_cont, csis_descont, delta, C_stat)
