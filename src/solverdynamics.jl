function calc_GH_dynamic!(mesh::Mesh, material::Vector{Material}, solver_var::Assembly, frequency::Float64)
...
function calc_GH_dynamic_gpu!(mesh::Mesh, material::Vector{Material}, solver_var::Assembly, frequency::Float64)
